...
ko:{
  ...
  'index.heroSub':'지금 예약할지, 6월 공시까지 기다릴지 노선별로 확인하세요',
  /* form */
  ...
  'index.decision.title':'📊 현재 유류할증료 흐름',
  'index.decision.line1':'✔ 최근 유가 하락 반영 구간',
  'index.decision.line2':'✔ 다음달 공시 시 변동 가능성 존재',
  'index.decision.line3':'✔ 장거리 노선일수록 영향 큼',
  'index.decision.conclusion':'👉 예약 시점에 따라 적용 금액이 달라질 수 있습니다',
  /* landing */
  ...
  'aff.myrealtrip.desc':        '유류할증료는 발권 시점 기준으로 적용됩니다. 지금 가격과 6월 전망을 함께 보고 예약 타이밍을 판단하세요.',
  ...
  'news.marketTitle':'🌍 시장 브리핑 (2026.05.07 08:45 기준)',
  'news.brent':'⛽ 브렌트유: 약 $100~102 / 배럴 — 고점 대비 일부 하락',
  'news.fx':'💱 원달러 환율: 약 1,440~1,450원 — 안정 시도',
  'news.mops':'✈️ 항공유/MOPS: 약 480~490 cent/gal — 500선 하회권 재진입 시도',
  'news.geo':'🌍 지정학: 중동 리스크 지속 (호르무즈/이란 변수)',
  'news.marketSummary':'→ 상승 사이클 종료 후 하락 전환 시도 진행 중',
  'news.fxDominance':'💡 핵심 신호: 6월 유류할증료 인하 가능성 우세 (변동성 매우 큼)',
  'news.decisionTitle':'📌 현재 판단 기준',
  'news.decisionLine1':'→ 상승 사이클 종료 가능성 확대 — 하락 전환 시도 중',
  'news.decisionLine2':'→ 항공사 비용 부담은 여전히 높은 상태 유지',
  'news.decisionShort':'👉 단거리 노선: 현재 예약 가능 구간',
  'news.decisionMid':'👉 장거리 노선: 6월 공시 확인 후 예약 권장',
  'news.decisionLong':'👉 중동 변수 발생 시 재상승 가능성 존재',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'전체',
  'news.dataRef':        '🕐 데이터 기준: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'현재 기준 요약 (2026.05.07):',
  'news.curSummary':     '→ 6월 유류할증료 인하 가능성 우세 (단, 변동성 매우 큰 상태)',
  /* 핵심 요약 카드 i18n */
  'news.summary.title':   '📌 2026년 6월 핵심 요약',
  'news.summary.updated': '🕐 2026.05.07 08:45 기준 시장 지표 반영',
  'news.summary.li1':     '브렌트유 고점 대비 일부 하락 흐름 유지',
  'news.summary.li2':     '항공유(MOPS) 500 cent 아래 재진입 시도',
  'news.summary.li3':     '원달러 환율 1440~1450원대 안정 흐름',
  'news.summary.li4':     '중동 지정학 리스크는 여전히 유지',
  'news.summary.li5':     '6월 유류할증료 인하 가능성 우세',
  'news.summary.li6':     '단기 변동성은 매우 큰 상태',
  ...
  'news.fixed.20260507a.title':'국제유가 일부 조정… 6월 유류할증료 인하 가능성 확대',
  'news.fixed.20260507a.summary':'브렌트유와 항공유 가격이 최고점 대비 일부 하락하며 6월 유류할증료 인하 가능성이 커지고 있다. 다만 중동 리스크는 여전히 남아있다.',
...
en:{
  ...
  'index.heroSub':'Book now or wait for the June filing? Check by route.',
  ...
  'index.decision.title':'📊 Current Surcharge Trend',
  'index.decision.line1':'✔ Recent oil price decline reflected',
  'index.decision.line2':'✔ Next month\'s filing may change the amount',
  'index.decision.line3':'✔ Long-haul routes are more impacted',
  'index.decision.conclusion':'👉 The applied surcharge may vary depending on when you book',
  ...
  'aff.myrealtrip.desc':        'Surcharges apply at the time of ticketing. Compare current prices with the June outlook before deciding.',
  ...
  'news.marketTitle':'🌍 Market Brief (as of 2026.05.07 08:45 KST)',
  'news.brent':'⛽ Brent Crude: ~$100–102/bbl — partially declining from highs',
  'news.fx':'💱 USD/KRW: ~KRW 1,440–1,450 — stabilization attempt',
  'news.mops':'✈️ Jet Fuel/MOPS: ~480–490 cent/gal — attempting below 500',
  'news.geo':'🌍 Geopolitics: Middle East risk persists (Hormuz/Iran variable)',
  'news.marketSummary':'→ Downward transition attempt after end of upward cycle',
  'news.fxDominance':'💡 Key signal: June surcharge cut likely (high volatility remains)',
  'news.decisionTitle':'📌 Current Decision Guide',
  'news.decisionLine1':'→ Upward cycle may be ending — downward transition in progress',
  'news.decisionLine2':'→ Airline cost burden remains elevated',
  'news.decisionShort':'👉 Short-haul routes: booking viable now',
  'news.decisionMid':'👉 Long-haul routes: recommended to confirm June filing first',
  'news.decisionLong':'👉 Middle East volatility could trigger a rebound if risk escalates',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'All',
  'news.dataRef':        '🕐 Data as of: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'Current Market Summary (2026.05.07):',
  'news.curSummary':     '→ June surcharge cut likely to prevail (very high volatility)',
  /* summary card i18n */
  'news.summary.title':   '📌 June 2026 Key Summary',
  'news.summary.updated': '🕐 Market indicators as of 2026.05.07 08:45 KST',
  'news.summary.li1':     'Brent crude partially declining from recent highs',
  'news.summary.li2':     'Jet fuel (MOPS) attempting to re-enter below 500 cent',
  'news.summary.li3':     'USD/KRW stabilizing in 1,440–1,450 range',
  'news.summary.li4':     'Middle East geopolitical risk persists',
  'news.summary.li5':     'June surcharge cut likely to prevail',
  'news.summary.li6':     'Near-term volatility remains very high',
  ...
  'news.fixed.20260507a.title':'Oil prices partially ease… June surcharge cut probability grows',
  'news.fixed.20260507a.summary':'Brent crude and jet fuel prices have partially declined from peak levels, increasing the likelihood of a June surcharge reduction. Middle East risks remain in place, however.',
...
ja:{
  ...
  'index.heroSub':'今すぐ予約 vs 6月公示まで待つ — 路線別に確認しましょう',
  ...
  'index.decision.title':'📊 現在の燃油サーチャージ動向',
  'index.decision.line1':'✔ 最近の原油価格下落が反映中',
  'index.decision.line2':'✔ 翌月公示で金額が変動する可能性あり',
  'index.decision.line3':'✔ 長距離路線ほど影響が大きい',
  'index.decision.conclusion':'👉 予約時期により適用金額が異なる場合があります',
  ...
  'aff.myrealtrip.desc':        '燃油サーチャージは発券日基準で適用されます。現在の価格と6月見通しを見て予約タイミングを判断しましょう。',
  ...
  'news.marketTitle':'🌍 市場ブリーフィング (2026.05.07 08:45 KST基準)',
  ...
  'news.fxDominance':'💡 キーシグナル: 6月サーチャージ引き下げ可能性優勢（変動性は非常に大きい）',
  'news.decisionTitle':'📌 現在の判断基準',
  'news.decisionLine1':'→ 上昇サイクル終了の可能性が拡大 — 下落転換試み中',
  'news.decisionLine2':'→ 航空会社のコスト負担は依然として高水準を維持',
  'news.decisionShort':'👉 短距離路線: 現在予約可能な区間',
  'news.decisionMid':'👉 長距離路線: 6月公示確認後の予約を推奨',
  'news.decisionLong':'👉 中東変数が発生した場合、再上昇の可能性あり',
  /* 6月予測CTAボックス */
  ...
  'news.filterAll':'すべて',
  'news.dataRef':        '🕐 データ基準: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'現在の基準要約 (2026.05.07):',
  'news.curSummary':     '→ 6月サーチャージ引き下げ可能性優勢（ただし変動性は非常に大きい）',
  /* summary card i18n (ja — en fallback) */
  'news.summary.title':   '📌 2026年6月 主要サマリー',
  'news.summary.updated': '🕐 2026.05.07 08:45 KST 市場指標反映',
  ...
  'news.summary.li5':     '6月燃油サーチャージ引き下げ可能性が優勢',
  ...
  'news.fixed.20260507a.title':'国際油価が一部調整… 6月サーチャージ引き下げ可能性が拡大',
  'news.fixed.20260507a.summary':'ブレント原油と航空燃油価格が高値から一部下落し、6月サーチャージ引き下げの可能性が高まっている。ただし中東リスクは依然として残っている。',
...
zh:{
  ...
  'index.decision.title':'📊 当前燃油附加费走势',
  'index.decision.line1':'✔ 近期油价下跌已反映在附加费中',
  'index.decision.line2':'✔ 下月公告可能带来金额变动',
  'index.decision.line3':'✔ 长途航线影响更大',
  'index.decision.conclusion':'👉 预订时间不同，适用金额可能有所不同',
  ...
  'aff.myrealtrip.desc':        '燃油附加费按出票日期适用。结合当前价格和6月展望，判断预订时机。',
  ...
  'news.marketTitle':'🌍 市场简报 (2026.05.07 08:45 KST)',
  ...
  'news.fxDominance':'💡 核心信号: 6月附加费下调可能性占优（波动性依然极大）',
  'news.decisionTitle':'📌 当前判断参考',
  'news.decisionLine1':'→ 上涨周期结束可能性扩大 — 下行转换尝试中',
  'news.decisionLine2':'→ 航空公司成本压力仍维持在较高水平',
  'news.decisionShort':'👉 短途航线: 当前可预订区间',
  'news.decisionMid':'👉 长途航线: 建议确认6月公告后再预订',
  'news.decisionLong':'👉 中东变量若爆发，存在再次上涨的可能',
  /* 6月预测CTA框 */
  ...
  'news.filterAll':'全部',
  'news.dataRef':        '🕐 数据基准: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'当前基准摘要 (2026.05.07):',
  'news.curSummary':     '→ 6月附加费：下调可能性占优（但波动性极大）',
  /* summary card i18n (zh) */
  'news.summary.title':   '📌 2026年6月核心摘要',
  'news.summary.updated': '🕐 反映2026.05.07 08:45 KST市场指标',
  ...
  'news.summary.li5':     '6月燃油附加费下调可能性占优',
  ...
  'news.fixed.20260507a.title':'国际油价小幅回调… 6月附加费下调可能性扩大',
  'news.fixed.20260507a.summary':'布伦特原油与航空燃油价格较高点小幅回落，6月燃油附加费下调可能性提升。但中东风险依然存在。',
...
fr:{
  ...
  'index.heroSub':'Réserver maintenant ou attendre les tarifs de juin ? Vérifiez par route.',
  ...
  'index.signal1':'📉 Baisse juin probable',
  ...
  'index.decision.title':'📊 Tendance actuelle de la surcharge',
  'index.decision.line1':'✔ La baisse récente du pétrole est reflétée',
  'index.decision.line2':'✔ Le prochain tarif officiel peut changer le montant',
  'index.decision.line3':'✔ Les vols long-courrier sont davantage concernés',
  'index.decision.conclusion':'👉 Le montant appliqué peut varier selon la date de réservation',
  ...
  'aff.myrealtrip.desc':        'La surcharge s\'applique à la date d\'émission. Comparez les prix actuels et les prévisions de juin avant de décider.',
  ...
  'news.marketTitle':'🌍 Point marché (2026.05.07 08:45 KST)',
  ...
  'news.fxDominance':"💡 Signal clé: baisse de juin probable (volatilité très élevée)",
  'news.decisionTitle':'📌 Guide de décision actuel',
  'news.decisionLine1':'→ Fin probable du cycle haussier — retournement baissier en cours',
  'news.decisionLine2':'→ Les coûts des compagnies aériennes restent élevés',
  'news.decisionShort':'👉 Vols courts : réservation possible maintenant',
  'news.decisionMid':'👉 Vols longs : recommandé d\'attendre l\'annonce de juin',
  'news.decisionLong':'👉 Une escalade au Moyen-Orient pourrait déclencher une remontée',
  ...
  'news.filterAll':'Tout',
  'news.dataRef':        '🕐 Données au: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'Résumé actuel (2026.05.07) :',
  'news.curSummary':     '→ Surcharge juin: baisse probable mais forte volatilité',
  /* summary card i18n (fr — en content) */
  'news.summary.title':   '📌 Résumé clé — juin 2026',
  'news.summary.updated': '🕐 Indicateurs marché au 2026.05.07 08:45 KST',
  ...
  'news.summary.li5':     'Baisse de la surcharge de juin probable',
  ...
  'news.fixed.20260507a.title':'Léger repli du pétrole… probabilité de baisse en juin en hausse',
  'news.fixed.20260507a.summary':'Le Brent et le kérosène sont en léger repli par rapport aux sommets, augmentant la probabilité d\'une baisse de surcharge en juin. Les risques au Moyen-Orient persistent néanmoins.',
...
de:{
  ...
  'index.heroSub':'Jetzt buchen oder bis zur Juni-Bekanntgabe warten? Streckenweise prüfen.',
  ...
  'index.signal1':'📉 Juni-Senkung wahrscheinlich',
  ...
  'index.decision.title':'📊 Aktuelle Zuschlagsentwicklung',
  'index.decision.line1':'✔ Jüngster Ölpreisrückgang ist eingepreist',
  'index.decision.line2':'✔ Die nächste offizielle Bekanntgabe kann den Betrag ändern',
  'index.decision.line3':'✔ Langstrecken sind stärker betroffen',
  'index.decision.conclusion':'👉 Der angewandte Zuschlag kann je nach Buchungszeitpunkt variieren',
  ...
  'aff.myrealtrip.desc':        'Zuschläge gelten ab Ausstellungsdatum. Vergleichen Sie aktuelle Preise und die Juni-Prognose, bevor Sie buchen.',
  ...
  'news.marketTitle':'🌍 Marktüberblick (2026.05.07 08:45 KST)',
  ...
  'news.fxDominance':'💡 Kernsignal: Juniabsenkung wahrscheinlich (sehr hohe Volatilität)',
  'news.decisionTitle':'📌 Aktuelle Entscheidungshilfe',
  'news.decisionLine1':'→ Ende des Aufwärtszyklus zeichnet sich ab — Abwärtswende im Gange',
  'news.decisionLine2':'→ Kostenbelastung der Fluggesellschaften bleibt hoch',
  'news.decisionShort':'👉 Kurzstrecke: Buchung jetzt möglich',
  'news.decisionMid':'👉 Langstrecke: Empfohlen, die Juni-Bekanntgabe abzuwarten',
  'news.decisionLong':'👉 Bei Nahost-Eskalation ist eine erneute Preiserhöhung möglich',
  ...
  'news.filterAll':'Alle',
  'news.dataRef':        '🕐 Datenstand: 2026.05.07 08:45 KST',
  'news.curSummaryTitle':'Aktuelle Zusammenfassung (2026.05.07):',
  'news.curSummary':     '→ Juni-Zuschlag: Absenkung wahrscheinlich, aber sehr hohe Volatilität',
  /* summary card i18n (de) */
  'news.summary.title':   '📌 Juni 2026 Kernzusammenfassung',
  'news.summary.updated': '🕐 Marktdaten vom 2026.05.07 08:45 KST',
  ...
  'news.summary.li5':     'Juni-Zuschlagsenkung wahrscheinlich',
  ...
  'news.fixed.20260507a.title':'Ölpreise geben etwas nach… Wahrscheinlichkeit einer Juni-Senkung steigt',
  'news.fixed.20260507a.summary':'Brent-Rohöl und Kerosin sind leicht von den Hochs gesunken, was die Wahrscheinlichkeit einer Juni-Zuschlagsenkung erhöht. Die Nahost-Risiken bestehen jedoch weiterhin.',
