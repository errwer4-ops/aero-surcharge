...
ko:{
  ...
  'index.decision.title':'📊 6월 변동성 확대 구간',
  'index.decision.line1':'✔ 유가·환율 변수 지속 주시 필요',
  'index.decision.line2':'✔ 다음달 공시 시 변동 가능성 존재',
  'index.decision.line3':'✔ 장거리 노선일수록 영향 큼',
  'index.decision.conclusion':'👉 공식 공시와 시장 지표 확인 필요',
  /* landing */
  ...
  'news.marketTitle':'🌍 시장 브리핑 (2026.05.12 20:50 KST 기준)',
  'news.brent':'⛽ 브렌트유: 장중 약 $107.68/bbl — 재상승 흐름, 고점 재진입',
  'news.fx':'💱 원달러 환율: 약 1,475~1,488원 구간, 1,470원대 후반 압박 지속',
  'news.mops':'✈️ 항공유/MOPS: 최신 확인치 기준 참고 — 공식 벤치마크 별도 확인 필요',
  'news.geo':'🌍 지정학: 호르무즈 해협 리스크 재확대 — 이란 작전 구역 확장 주장, 미·이란 휴전 불확실',
  'news.marketSummary':'→ 브렌트유 재상승 + 환율 1,470원대 후반 + 호르무즈 리스크 복합 — 6월 인하폭 제한 가능성 확대',
  'news.fxDominance':'🌍 유가·환율 변수 주시 (6월 변동성 확대 구간)',
  'news.decisionTitle':'📌 현재 판단 기준',
  'news.decisionLine1':'→ 브렌트유 재상승($107대)·환율 1,470원대 후반·호르무즈 리스크 복합 — 인하폭 제한 구조',
  'news.decisionLine2':'→ MOPS 하락 압력은 존재하나 실제 인하폭은 상기 변수에 의해 제한 가능',
  'news.decisionShort':'👉 단거리: 현재 예약 가능한 구간',
  'news.decisionMid':'👉 중장거리: 환율(1,470원대 후반)과 공식 공시 확인 후 판단',
  'news.decisionLong':'👉 장거리: 브렌트유 재상승·호르무즈 리스크·환율 동시 재확인 권장 (공식 공시 필수)',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'전체',
  'news.dataRef':        '🕐 데이터 기준: 2026.05.12 20:50 KST',
  'news.curSummaryTitle':'현재 기준 요약 (2026.05.12):',
  'news.curSummary':     '→ 6월 유류할증료: 브렌트유 재상승·환율 1,470원대 후반·호르무즈 리스크로 인하폭 제한 가능. 공식 공시 확인 필요',
  /* 핵심 요약 카드 i18n */
  'news.summary.title':   '📌 2026년 6월 핵심 요약',
  'news.summary.updated': '🕐 2026.05.12 20:50 KST 기준 시장 지표 반영',
  'news.summary.li1':     '브렌트유 장중 약 $107.68/bbl 재상승 — WTI도 $101.61대',
  'news.summary.li2':     '항공유(MOPS) 하락 압력 존재 — 단, 최신 MOPS 공식 수치 별도 확인 필요',
  'news.summary.li3':     '원달러 환율 약 1,475~1,488원 구간, 1,470원대 후반 압박',
  'news.summary.li4':     '호르무즈 해협 리스크 재확대 — 이란 작전 구역 확장 주장, 미·이란 휴전 불확실',
  'news.summary.li5':     '6월 유류할증료: MOPS 하락 압력 있으나 브렌트유 재상승·환율·호르무즈 리스크로 인하폭 제한 가능',
  'news.summary.li6':     '변동성 매우 큰 상태 — 공식 공시 전 모니터링 필요',
  ...
  'news.metaDesc':'5월 유류할증료 현황과 6월 전망을 유가·환율 변수 중심으로 정리합니다. 공식 공시와 시장 지표를 함께 확인하세요.',
  /* footer */
...
en:{
  ...
  'index.signal1':'📊 June volatility zone',
  ...
  'airport.XMN':'Xiamen','airport.CSX':'Changsha','airport.KHH':'Kaohsiung','airport.RMQ':'Taichung',
  ...
  'index.decision.title':'📊 June Volatility Zone',
  'index.decision.line1':'✔ Oil price & FX variables require monitoring',
  'index.decision.line2':'✔ Next month\'s filing may change the amount',
  'index.decision.line3':'✔ Long-haul routes are more impacted',
  'index.decision.conclusion':'👉 Verify official filings and market indicators before booking',
  ...
  'news.marketTitle':'🌍 Market Brief (as of 2026.05.12 20:50 KST)',
  'news.brent':'⛽ Brent Crude: intraday ~$107.68/bbl — rebounding, re-entering high zone',
  'news.fx':'💱 USD/KRW: ~1,475–1,488 KRW range, late-1,470s pressure sustained',
  'news.mops':'✈️ Jet Fuel/MOPS: latest available figure — official benchmark confirmation required',
  'news.geo':'🌍 Geopolitics: Hormuz Strait risk re-escalating — Iran claims wider operational zone, US-Iran ceasefire uncertain',
  'news.marketSummary':'→ Brent rebounding + USD/KRW late-1,470s + Hormuz risk compound — June cut size likely constrained',
  ...
  'news.decisionShort':'👉 Short-haul routes: bookable now',
  'news.decisionMid':'👉 Mid/long-haul: check USD/KRW (late-1,470s) and official filing before booking',
  'news.decisionLong':'👉 Long-haul: re-verify Brent rebound, Hormuz risk and exchange rate simultaneously (official filing required)',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'All',
  'news.dataRef':        '🕐 Data as of: 2026.05.12 20:50 KST',
  'news.curSummaryTitle':'Current Market Summary (2026.05.12):',
  'news.curSummary':     '→ June surcharge: Brent rebound + USD/KRW late-1,470s + Hormuz risk — cut size likely limited. Check official filing.',
  /* summary card i18n */
  'news.summary.title':   '📌 June 2026 Key Summary',
  'news.summary.updated': '🕐 Market indicators as of 2026.05.12 20:50 KST',
  'news.summary.li1':     'Brent crude intraday ~$107.68/bbl — rebounding; WTI also ~$101.61',
  'news.summary.li2':     'Jet fuel (MOPS) downward pressure exists — but latest official benchmark figure needs separate confirmation',
  'news.summary.li3':     'USD/KRW ~1,475–1,488 KRW range, sustained late-1,470s pressure',
  'news.summary.li4':     'Hormuz Strait risk re-escalating — Iran claims wider operational zone, US-Iran ceasefire on shaky ground',
  'news.summary.li5':     'June surcharge: MOPS cut pressure present, but Brent rebound + FX + Hormuz risk may limit actual reduction',
  'news.summary.li6':     'Very high volatility — monitor until official filings',
...
ja:{
  ...
  'airport.PQC':'フーコック','airport.RGN':'ヤンゴン','airport.KTM':'カトマンズ',
  ...
  'index.decision.title':'📊 6月変動性拡大区間',
  'index.decision.line1':'✔ 原油価格・為替変数の継続的な確認が必要',
  'index.decision.line2':'✔ 翌月公示で金額が変動する可能性あり',
  'index.decision.line3':'✔ 長距離路線ほど影響が大きい',
  'index.decision.conclusion':'👉 公式公示と市場指標の確認が必要',
...
zh:{
  ...
  'airport.PQC':'富国岛','airport.RGN':'仰光','airport.KTM':'加德满都',
  ...
  'index.decision.title':'📊 6月波动性扩大区间',
  'index.decision.line1':'✔ 需持续关注油价及汇率变量',
  'index.decision.line2':'✔ 下月公告可能带来金额变动',
  'index.decision.line3':'✔ 长途航线影响更大',
  'index.decision.conclusion':'👉 需确认官方公告与市场指标',
...
fr:{
  ...
  'index.signal1':'📊 Zone de volatilité juin',
  ...
  'index.decision.title':'📊 Zone de volatilité juin',
  'index.decision.line1':'✔ Les variables pétrole & change nécessitent un suivi',
  ...
  'index.decision.conclusion':'👉 Vérifiez les annonces officielles et les indicateurs de marché',
  ...
  'news.decisionMid':'👉 Vols longs : confirmer l\'annonce de juin et les indicateurs de marché',
...
de:{
  ...
  'index.signal1':'📊 Juni-Volatilitätszone',
  ...
  'index.decision.title':'📊 Juni-Volatilitätszone',
  'index.decision.line1':'✔ Öl- und Wechselkursvariablen erfordern laufende Beobachtung',
  ...
  'index.decision.conclusion':'👉 Offizielle Bekanntgaben und Marktindikatoren vor der Buchung prüfen',
