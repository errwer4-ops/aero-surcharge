...
ko:{
  ...
  'news.brent':'⛽ 브렌트유: $82 → $79~81 추가 하락 (하락 흐름 유지)',
  'news.fx':'💱 원달러 환율: 1,470 → 1,460원대 소폭 하락 (여전히 높은 수준)',
  'news.geo':'🌍 지정학: 중동 긴장 완화 유지 (추가 리스크 없음)',
  'news.marketSummary':'→ 5월 유류할증료는 고점 반영 완료, 6월은 하락 압력 발생 구간 진입',
...
en:{
  ...
  'news.brent':'⛽ Brent Crude: $82 → $79–81 continued decline (downtrend maintained)',
  'news.fx':'💱 USD/KRW: 1,470 → 1,460s slight easing (still elevated)',
  'news.geo':'🌍 Geopolitics: Middle East tensions easing (no new risk)',
  'news.marketSummary':'→ May surcharges fully reflect peak; June entering downward pressure zone',
...
ja:{
  ...
  'news.brent':'⛽ ブレント原油: $82 → $79〜81 続落（下落トレンド継続）',
  'news.fx':'💱 ドル円/ウォン: 1,470 → 1,460台へ小幅下落（依然高水準）',
  'news.geo':'🌍 地政学: 中東緊張緩和維持（新たなリスクなし）',
  'news.marketSummary':'→ 5月は高値反映済み、6月は下落圧力局面に入る',
...
zh:{
  ...
  'news.brent':'⛽ 布伦特原油: $82 → $79~81 持续下跌（下行趋势维持）',
  'news.fx':'💱 美元/韩元: 1,470 → 1,460区间小幅回落（仍处高位）',
  'news.geo':'🌍 地缘政治: 中东紧张局势持续缓和（无新增风险）',
  'news.marketSummary':'→ 5月附加费已充分反映高点，6月进入下行压力区间',
...
fr:{
  ...
  'news.brent':'⛽ Brent: $82 → $79–81 recul continu (tendance baissière)',
  'news.fx':'💱 USD/KRW: 1 470 → 1 460 légère détente (niveau encore élevé)',
  'news.geo':'🌍 Géopolitique: tensions Moyen-Orient en baisse (pas de nouveau risque)',
  'news.marketSummary':'→ Pic de mai intégré ; juin entre en zone de pression baissière',
...
de:{
  ...
  'news.brent':'⛽ Brent-Rohöl: $82 → $79–81 weiterer Rückgang (Abwärtstrend hält an)',
  'news.fx':'💱 USD/KRW: 1.470 → 1.460er Bereich leichte Entspannung (weiterhin hoch)',
  'news.geo':'🌍 Geopolitik: Nahost-Spannungen weiter rückläufig (kein neues Risiko)',
  'news.marketSummary':'→ Mai-Zuschlag hat Hochpunkt vollständig eingepreist; Juni tritt in Abwärtsdruckzone ein',
