...
ko:{
  ...
  'news.marketTitle':'🌍 시장 브리핑 (2026.05.02 08:50 기준)',
  'news.brent':'⛽ 브렌트유: 약 $103~105 / 배럴 (하락 지속)',
  'news.fx':'💱 원달러 환율: 약 1,445~1,455원 (하락 전환 지속)',
  'news.mops':'✈️ 항공유/MOPS: 490~495 cent/gal — 500선 이탈, 하락 구간 진입',
  'news.geo':'🌍 지정학: 중동 리스크 유지 (하방 제한 요인)',
  'news.marketSummary':'→ 유류할증료 하락 조건 3개 강화 (유가·환율·항공유)',
  'news.fxDominance':'💡 핵심 신호: 인하 가능성 우세 강화 (일부 구간 동결 가능)',
  'news.decisionTitle':'📌 현재 판단 기준',
  'news.decisionLine1':'→ 5월 유류할증료는 주요 항공사 인상 반영 완료',
  'news.decisionLine2':'→ 6월은 유가·환율·항공유 하락 신호가 강화되며 인하 가능성 우세',
  'news.decisionShort':'👉 단기 여행: 현재 공시 기준 총액 확인 후 예약 판단',
  'news.decisionMid':'👉 여유 있는 일정: 6월 공시 발표 후 비교 권장',
  'news.decisionLong':'👉 장거리 노선: 공시 직후 하락폭 재확인 필요',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'전체',
  'news.dataRef':        '🕐 데이터 기준: 2026.05.02 08:50',
  'news.curSummaryTitle':'현재 기준 요약 (2026.05.02):',
  'news.curSummary':     '→ 6월 유류할증료는 인하 가능성 우세가 강화됨 (일부 구간 동결 가능)',
  /* 핵심 요약 카드 i18n */
  'news.summary.title':   '📌 2026년 6월 핵심 요약',
  'news.summary.updated': '🕐 2026.05.02 08:50 기준 시장 지표 반영',
  'news.summary.li1':     '유가 하락 지속 — 브렌트유 $103~105 / 배럴',
  'news.summary.li2':     '환율 하락 전환 지속 — 약 1,445~1,455원',
  'news.summary.li3':     '항공유 하락 구간 진입 — 490~495 cent, 500선 이탈',
  'news.summary.li4':     '하락 조건 3개 동시 충족 강화 (유가·환율·항공유)',
  'news.summary.li5':     '6월 유류할증료 인하 가능성 우세 강화',
...
en:{
  ...
  'news.marketTitle':'🌍 Market Brief (as of 2026.05.02 08:50 KST)',
  'news.brent':'⛽ Brent Crude: ~$103–105 / bbl (declining)',
  'news.fx':'💱 USD/KRW: ~KRW 1,445–1,455 (turning lower)',
  'news.mops':'✈️ Jet Fuel/MOPS: 490–495 cent/gal — below 500, downside zone',
  'news.geo':'🌍 Geopolitics: Middle East risk persists (limits downside)',
  'news.marketSummary':'→ All three downside conditions strengthened (oil, FX, jet fuel)',
  'news.fxDominance':'💡 Key signal: Cut likelihood strengthened (some routes may hold flat)',
  ...
  'news.decisionLine2':'→ June: oil, FX, and jet fuel downside signals strengthened — cut likelihood rising',
  'news.decisionShort':'👉 Short trip: confirm total at current filing, then decide',
  'news.decisionMid':'👉 Flexible schedule: compare after June notices are published',
  'news.decisionLong':'👉 Long-haul: re-verify drop size immediately after official notice',
  /* 6월 전망 CTA 박스 */
  ...
  'news.filterAll':'All',
  'news.dataRef':        '🕐 Data as of: 2026.05.02 08:50 KST',
  'news.curSummaryTitle':'Current Market Summary (2026.05.02):',
  'news.curSummary':     '→ June surcharge cut likelihood has strengthened (some routes may hold flat)',
  /* summary card i18n */
  'news.summary.title':   '📌 June 2026 Key Summary',
  'news.summary.updated': '🕐 Market indicators as of 2026.05.02 08:50 KST',
  'news.summary.li1':     'Oil declining — Brent at $103–105/bbl',
  'news.summary.li2':     'FX continues turning lower — about KRW 1,445–1,455',
  'news.summary.li3':     'Jet fuel entering downside zone — 490–495 cent, below 500',
  'news.summary.li4':     'All three downside conditions strengthened (oil, FX, jet fuel)',
  'news.summary.li5':     'June surcharge cut likelihood has strengthened',
...
ja:{
  ...
  'news.marketTitle':'🌍 市場ブリーフィング (2026.05.02 08:50 KST基準)',
  'news.brent':'⛽ ブレント原油: 約$103〜105 / バレル (下落継続)',
  'news.fx':'💱 ウォン/ドル: 約1,445〜1,455ウォン (下落転換継続)',
  'news.mops':'✈️ 航空燃料/MOPS: 490〜495セント/ガロン — 500割れ、下落区間進入',
  'news.geo':'🌍 地政学: 中東リスク継続（下方制限要因）',
  'news.marketSummary':'→ 下落条件3つ強化（油価・為替・航空燃油）',
  'news.fxDominance':'💡 キーシグナル: 引き下げ可能性優勢強化（一部区間据え置き可能）',
  'news.decisionTitle':'📌 現在の判断基準',
  'news.decisionLine1':'→ 5月：主要航空会社の引き上げ反映完了',
  'news.decisionLine2':'→ 6月：油価・為替・航空燃油の下落シグナル強化 — 引き下げ可能性優勢',
  'news.decisionShort':'👉 短期旅行: 現在公示基準の総額確認後に予約判断',
  'news.decisionMid':'👉 日程に余裕あり: 6月公示発表後に比較推奨',
  'news.decisionLong':'👉 長距離路線: 公示直後に下落幅を再確認',
  /* 6月予測CTAボックス */
  ...
  'news.filterAll':'すべて',
  'news.dataRef':        '🕐 データ基準: 2026.05.02 08:50 KST',
  'news.curSummaryTitle':'現在の基準要約 (2026.05.02):',
  'news.curSummary':     '→ 6月燃油サーチャージ：引き下げ可能性優勢強化（一部区間据え置き可能）',
  /* summary card i18n (ja — en fallback) */
  'news.summary.title':   '📌 2026年6月 主要サマリー',
  'news.summary.updated': '🕐 2026.05.02 08:50 KST 市場指標反映',
  'news.summary.li1':     '油価下落継続 — ブレント $103〜105/バレル',
  'news.summary.li2':     '為替下落転換継続 — 約1,445〜1,455ウォン',
  'news.summary.li3':     '航空燃油下落区間進入 — 490〜495セント、500割れ',
  'news.summary.li4':     '下落条件3つ同時強化（油価・為替・航空燃油）',
  'news.summary.li5':     '6月サーチャージ引き下げ可能性優勢強化',
...
zh:{
  ...
  'news.marketTitle':'🌍 市场简报 (2026.05.02 08:50 KST)',
  'news.brent':'⛽ 布伦特原油: 约$103~105 / 桶 (持续下跌)',
  'news.fx':'💱 美元/韩元: 约1,445~1,455韩元 (持续下行转向)',
  'news.mops':'✈️ 航空燃油/MOPS: 490~495美分/加仑 — 跌破500，进入下行区间',
  'news.geo':'🌍 地缘政治: 中东风险持续（限制下行速度）',
  'news.marketSummary':'→ 三项下行条件同时强化（油价·汇率·航空燃油）',
  'news.fxDominance':'💡 核心信号: 下调可能性优势强化（部分区间可能维持）',
  'news.decisionTitle':'📌 当前判断参考',
  'news.decisionLine1':'→ 5月：主要航空公司涨价反映完成',
  'news.decisionLine2':'→ 6月：油价、汇率、航空燃油下行信号强化 — 下调可能性优势上升',
  'news.decisionShort':'👉 短途旅行: 按当前公告确认总额后决定',
  'news.decisionMid':'👉 时间充裕: 建议6月公告发布后比较',
  'news.decisionLong':'👉 长途航线: 公告发布后立即再确认降幅',
  /* 6月预测CTA框 */
  ...
  'news.filterAll':'全部',
  'news.dataRef':        '🕐 数据基准: 2026.05.02 08:50 KST',
  'news.curSummaryTitle':'当前基准摘要 (2026.05.02):',
  'news.curSummary':     '→ 6月附加费：下调可能性优势强化（部分区间可能维持）',
  /* summary card i18n (zh) */
  'news.summary.title':   '📌 2026年6月核心摘要',
  'news.summary.updated': '🕐 反映2026.05.02 08:50 KST市场指标',
  'news.summary.li1':     '油价持续下跌 — 布伦特$103~105/桶',
  'news.summary.li2':     '汇率持续下行转向 — 约1,445~1,455韩元',
  'news.summary.li3':     '航空燃油进入下行区间 — 490~495美分，跌破500',
  'news.summary.li4':     '三项下行条件同时强化（油价·汇率·航空燃油）',
  'news.summary.li5':     '6月燃油附加费下调可能性优势强化',
...
fr:{
  ...
  'news.marketTitle':'🌍 Point marché (2026.05.02 08:50 KST)',
  'news.brent':'⛽ Brent: ~103–105 $ / baril (en baisse)',
  'news.fx':'💱 USD/KRW: ~KRW 1 445–1 455 (en recul)',
  'news.mops':'✈️ Kérosène/MOPS: 490–495 cent/gal — sous 500, zone baissière',
  'news.geo':"🌍 Géopolitique: risques Moyen-Orient persistants (limite la baisse)",
  'news.marketSummary':'→ Les trois conditions baissières renforcées (pétrole, change, kérosène)',
  'news.fxDominance':"💡 Signal clé: probabilité de baisse renforcée (certaines routes peuvent tenir)",
  ...
  'news.decisionLine2':'→ Juin : signaux baissiers renforcés — probabilité de baisse en hausse',
  'news.decisionShort':'👉 Voyage court terme : confirmez le total au tarif actuel, puis décidez',
  'news.decisionMid':'👉 Planning flexible : comparez après la publication des annonces de juin',
  'news.decisionLong':'👉 Long-courrier : re-vérifiez la baisse juste après l\'annonce officielle',
  ...
  'news.filterAll':'Tout',
  'news.dataRef':        '🕐 Données au: 2026.05.02 08:50 KST',
  'news.curSummaryTitle':'Résumé actuel (2026.05.02) :',
  'news.curSummary':     '→ Surcharge juin: probabilité de baisse renforcée (certaines routes peuvent tenir)',
  /* summary card i18n (fr — en content) */
  'news.summary.title':   '📌 Résumé clé — juin 2026',
  'news.summary.updated': '🕐 Indicateurs marché au 2026.05.02 08:50 KST',
  'news.summary.li1':     'Pétrole en baisse — Brent à $103–105/baril',
  'news.summary.li2':     'Change en recul — environ KRW 1 445–1 455',
  'news.summary.li3':     'Kérosène en zone baissière — 490–495 cent, sous 500',
  'news.summary.li4':     'Les trois conditions baissières renforcées (pétrole, change, kérosène)',
  'news.summary.li5':     'Probabilité de baisse de la surcharge de juin renforcée',
...
de:{
  ...
  'news.marketTitle':'🌍 Marktüberblick (2026.05.02 08:50 KST)',
  'news.brent':'⛽ Brent-Rohöl: ~103–105 $ / Barrel (sinkend)',
  'news.fx':'💱 USD/KRW: ~KRW 1.445–1.455 (abwärts)',
  'news.mops':'✈️ Kerosin/MOPS: 490–495 Cent/gal — unter 500, Abwärtszone',
  'news.geo':'🌍 Geopolitik: Nahost-Risiken bestehen (begrenzen Rückgang)',
  'news.marketSummary':'→ Alle drei Abwärtsbedingungen verstärkt (Öl, Wechselkurs, Kerosin)',
  'news.fxDominance':'💡 Kernsignal: Senkungswahrscheinlichkeit verstärkt (einige Routen könnten stabil bleiben)',
  ...
  'news.decisionLine2':'→ Juni: Abwärtssignale verstärkt — Senkungswahrscheinlichkeit steigt',
  'news.decisionShort':'👉 Kurzreise: Gesamtbetrag laut aktuellem Tarif prüfen, dann entscheiden',
  'news.decisionMid':'👉 Flexibler Zeitplan: nach Veröffentlichung der Juni-Mitteilungen vergleichen',
  'news.decisionLong':'👉 Langstrecke: Senkungsbetrag direkt nach Bekanntgabe prüfen',
  ...
  'news.filterAll':'Alle',
  'news.dataRef':        '🕐 Datenstand: 2026.05.02 08:50 KST',
  'news.curSummaryTitle':'Aktuelle Zusammenfassung (2026.05.02):',
  'news.curSummary':     '→ Juni-Zuschlag: Senkungswahrscheinlichkeit verstärkt (einige Routen könnten stabil bleiben)',
  /* summary card i18n (de) */
  'news.summary.title':   '📌 Juni 2026 Kernzusammenfassung',
  'news.summary.updated': '🕐 Marktdaten vom 2026.05.02 08:50 KST',
  'news.summary.li1':     'Öl sinkend — Brent bei $103–105/Barrel',
  'news.summary.li2':     'Wechselkurs weiter abwärts — ca. KRW 1.445–1.455',
  'news.summary.li3':     'Kerosin in Abwärtszone — 490–495 Cent, unter 500',
  'news.summary.li4':     'Alle drei Abwärtsbedingungen verstärkt (Öl, Wechselkurs, Kerosin)',
  'news.summary.li5':     'Senkungswahrscheinlichkeit für Juni-Zuschlag verstärkt',
