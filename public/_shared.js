...
ko:{
  ...
  'news.brent':'⛽ 브렌트유: 약 $108~109 / 배럴 — 중동 리스크와 공급 불안으로 상승 압력 확대',
  'news.fx':'💱 원달러 환율: 약 1,474원 — 고환율 구간 유지',
  'news.mops':'✈️ 항공유/MOPS: 511.21 cent/gal — 최고 단계 구간 유지',
  'news.geo':'🌍 지정학: 중동 리스크와 공급 불안 지속',
  'news.marketSummary':'→ 유가와 환율이 동시에 높은 구간에 있어 6월 유류할증료 인하 신호는 약한 구조',
  'news.fxDominance':'💡 핵심 신호: 인하보다 동결 또는 추가 상승 가능성 우세',
  'news.decisionTitle':'📌 현재 판단 기준',
  'news.decisionLine1':'→ 5월은 주요 항공사 인상 반영 완료',
  'news.decisionLine2':'→ 6월은 유가·환율·항공유 부담이 동시에 남아 있어 인하를 단정하기 어려운 구조',
  ...
  'news.filterAll':'전체',
  'news.dataRef':        '🕐 데이터 기준: 2026.04.28 07:22',
  'news.curSummaryTitle':'현재 기준 요약 (2026.04.28):',
  'news.curSummary':     '→ 6월 유류할증료는 인하보다 동결 또는 추가 상승 가능성 우세',
...
en:{
  ...
  'news.brent':'⛽ Brent Crude: ~$108–109 / bbl — upward pressure from Middle East risk & supply concerns',
  'news.fx':'💱 USD/KRW: ~KRW 1,474 — still in elevated range',
  'news.mops':'✈️ Jet Fuel/MOPS: 511.21 cent/gal — in highest-tier range',
  'news.geo':'🌍 Geopolitics: Middle East risk and supply concerns remain',
  'news.marketSummary':'→ With oil and FX both elevated simultaneously, weak signal for a June surcharge cut',
  'news.fxDominance':'💡 Key signals: Flat or further increase more likely than a cut',
  ...
  'news.decisionLine2':'→ June: oil, FX, and jet fuel pressures all remain — hard to expect a cut',
  ...
  'news.filterAll':'All',
  'news.dataRef':        '🕐 Data as of: 2026.04.28 07:22',
  'news.curSummaryTitle':'Current Market Summary (2026.04.28):',
  'news.curSummary':     '→ June surcharge: flat or further increase more likely than a cut',
...
ja:{
  ...
  'news.brent':'⛽ ブレント原油: 約$108〜109 / バレル — 中東リスク・供給不安で上昇圧力拡大',
  'news.fx':'💱 ウォン/ドル: 約1,474ウォン — 高水準維持',
  'news.mops':'✈️ 航空燃料/MOPS: 511.21セント/ガロン — 最高段階区間維持',
  'news.geo':'🌍 地政学: 中東リスクと供給不安が継続',
  'news.marketSummary':'→ 油価と為替が同時に高水準にあり、6月引き下げシグナルは弱い構造',
  'news.fxDominance':'💡 キーシグナル: 据え置きまたは追加上昇の可能性が優勢',
  'news.decisionTitle':'📌 現在の判断基準',
  'news.decisionLine1':'→ 5月：主要航空会社の引き上げ反映完了',
  'news.decisionLine2':'→ 6月：油価・為替・航空燃料の負担が残っており、引き下げは断言しにくい構造',
  ...
  'news.filterAll':'すべて',
  'news.dataRef':        '🕐 データ基準: 2026.04.28 07:22',
  'news.curSummaryTitle':'現在の基準要約 (2026.04.28):',
  'news.curSummary':     '→ 6月燃油サーチャージ：据え置きまたは追加上昇の可能性が優勢',
...
zh:{
  ...
  'news.brent':'⛽ 布伦特原油: 约$108~109 / 桶 — 中东风险与供应不安引发上行压力扩大',
  'news.fx':'💱 美元/韩元: 约1,474韩元 — 仍处高位区间',
  'news.mops':'✈️ 航空燃油/MOPS: 511.21美分/加仑 — 维持最高级别区间',
  'news.geo':'🌍 地缘政治: 中东风险与供应不安持续',
  'news.marketSummary':'→ 油价与汇率同时处于高位，6月下调信号偏弱',
  'news.fxDominance':'💡 核心信号: 冻结或进一步上涨的可能性大于下调',
  'news.decisionTitle':'📌 当前判断参考',
  'news.decisionLine1':'→ 5月：主要航空公司涨价反映完成',
  'news.decisionLine2':'→ 6月：油价、汇率、航空燃油压力并存，难以断言下调',
  ...
  'news.filterAll':'全部',
  'news.dataRef':        '🕐 数据基准: 2026.04.28 07:22',
  'news.curSummaryTitle':'当前基准摘要 (2026.04.28):',
  'news.curSummary':     '→ 6月附加费：冻结或进一步上涨的可能性大于下调',
...
fr:{
  ...
  'news.brent':'⛽ Brent: ~108–109 $ / baril — pression haussière due aux risques géopolitiques',
  'news.fx':'💱 USD/KRW: ~KRW 1 474 — toujours en zone élevée',
  'news.mops':'✈️ Kérosène/MOPS: 511,21 cent/gal — zone de niveau maximal maintenue',
  'news.geo':'🌍 Géopolitique: risques Moyen-Orient et incertitudes d\'approvisionnement persistants',
  'news.marketSummary':'→ Pétrole et change simultanément élevés — signal faible pour une baisse en juin',
  'news.fxDominance':"💡 Signaux clés: Gel ou nouvelle hausse plus probable qu'une baisse",
  ...
  'news.decisionLine2':'→ Juin : pression pétrolière, change et kérosène simultanées — baisse difficile à confirmer',
  ...
  'news.filterAll':'Tout',
  'news.dataRef':        '🕐 Données au: 2026.04.28 07:22',
  'news.curSummaryTitle':'Résumé actuel (2026.04.28) :',
  'news.curSummary':     "→ Surcharge juin : gel ou hausse plus probable qu'une baisse",
...
de:{
  ...
  'news.brent':'⛽ Brent-Rohöl: ~108–109 $ / Barrel — Aufwärtsdruck durch Geopolitik und Angebotsrisiken',
  'news.fx':'💱 USD/KRW: ~KRW 1.474 — weiterhin in erhöhter Zone',
  'news.mops':'✈️ Kerosin/MOPS: 511,21 Cent/gal — höchste Preisstufe aufrechterhalten',
  'news.geo':'🌍 Geopolitik: Nahost-Risiken und Versorgungsunsicherheiten dauern an',
  'news.marketSummary':'→ Öl und Wechselkurs gleichzeitig erhöht — schwaches Signal für eine Senkung im Juni',
  'news.fxDominance':'💡 Kernsignale: Einfrieren oder weiterer Anstieg wahrscheinlicher als Senkung',
  ...
  'news.decisionLine2':'→ Juni: Öl-, Wechselkurs- und Kerosinbelastung besteht — Senkung kaum zu erwarten',
  ...
  'news.filterAll':'Alle',
  'news.dataRef':        '🕐 Datenstand: 2026.04.28 07:22',
  'news.curSummaryTitle':'Aktuelle Zusammenfassung (2026.04.28):',
  'news.curSummary':     '→ Juni-Zuschlag: Einfrieren oder weiterer Anstieg wahrscheinlicher als Senkung',
