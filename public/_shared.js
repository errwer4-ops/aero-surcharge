...
ko:{
  ...
  'news.brent':'⛽ 브렌트유: $105~106 안팎 / 배럴',
  'news.fx':'💱 원달러 환율: 1,470원대 후반',
  'news.mops':'✈️ 항공유/MOPS: 최근 고점 → 하락 전환 / 여전히 고가권',
  'news.geo':'🌍 지정학: 중동 리스크 완전 해소 아님 (호르무즈·중동 긴장 지속)',
  'news.marketSummary':'→ 5월 유류할증료는 고점 반영 완료, 6월은 하락 압력 일부 발생 가능하나 환율·지정학 변수로 인하 폭 제한 가능',
  'news.decisionTitle':'📌 현재 판단 기준',
  'news.decisionLine1':'→ 5월은 이미 고점 반영 완료',
  'news.decisionLine2':'→ 6월은 유가 하락 영향으로 인하 가능성 존재',
  'news.decisionShort':'👉 단기 여행(1~2개월): 지금 예약이 유리',
  'news.decisionLong':'👉 여유 있는 일정: 6월 추이 확인 후 예약 고려',
  ...
  'news.predict.mopsValue':'최근 평균 하락 전환',
  ...
  'news.predict.geoValue':'중간 (완화 조짐)',
  'news.predict.outlookLabel':'surcharge 전망',
  'news.predict.outlook.flat':'유지 ~ 소폭 인하 가능성',
...
en:{
  ...
  'news.brent':'⛽ Brent Crude: $105–106 / bbl',
  'news.fx':'💱 USD/KRW: KRW 1,470s (late)',
  'news.mops':'✈️ Jet Fuel/MOPS: Recent peak → turning lower / still elevated',
  'news.geo':'🌍 Geopolitics: Middle East risk not fully resolved (Hormuz/regional tensions persist)',
  'news.marketSummary':'→ May surcharges fully reflect peak; June may see limited downward pressure, but FX and geopolitical factors constrain any cut',
  'news.decisionTitle':'📌 Current Decision Guide',
  'news.decisionLine1':'→ May: peak pricing already locked in',
  'news.decisionLine2':'→ June: oil price drop may reduce surcharge',
  'news.decisionShort':'👉 Short trip (1–2 months out): book now for advantage',
  'news.decisionLong':'👉 Flexible schedule: consider waiting for June trend',
...
ja:{
  ...
  'news.brent':'⛽ ブレント原油: $105〜106 / バレル',
  'news.fx':'💱 ウォン/ドル: 1,470ウォン台後半',
  'news.mops':'✈️ 航空燃料/MOPS: 直近ピーク → 下落転換 / 依然高値圏',
  'news.geo':'🌍 地政学: 中東リスク完全解消されず（ホルムズ・中東緊張継続）',
  'news.marketSummary':'→ 5月は高値反映済み、6月は一部下落圧力発生も為替・地政学変数で下落幅は限定的',
  'news.decisionTitle':'📌 現在の判断基準',
  'news.decisionLine1':'→ 5月：高値反映完了',
  'news.decisionLine2':'→ 6月：原油安で引き下げの可能性',
  'news.decisionShort':'👉 短期旅行（1〜2ヶ月以内）：今すぐ予約が有利',
  'news.decisionLong':'👉 日程に余裕あり：6月の動向確認後に予約検討',
...
zh:{
  ...
  'news.brent':'⛽ 布伦特原油: $105~106 / 桶',
  'news.fx':'💱 美元/韩元: 1,470韩元后段',
  'news.mops':'✈️ 航空燃油/MOPS: 近期见顶 → 转跌 / 仍处高位',
  'news.geo':'🌍 地缘政治: 中东风险尚未完全解除（霍尔木兹·中东紧张持续）',
  'news.marketSummary':'→ 5月附加费已充分反映高点，6月下行压力有所显现，但汇率与地缘变量制约降幅',
  'news.decisionTitle':'📌 当前判断参考',
  'news.decisionLine1':'→ 5月：高点已反映完毕',
  'news.decisionLine2':'→ 6月：油价下跌可能带来降费可能',
  'news.decisionShort':'👉 短途旅行（1~2个月内）：现在预订更划算',
  'news.decisionLong':'👉 时间充裕：建议观察6月走势后再决定',
...
fr:{
  ...
  'news.brent':'⛽ Brent: $105–106 / baril',
  'news.fx':'💱 USD/KRW: KRW 1 470s (fin de fourchette)',
  'news.mops':'✈️ Kérosène/MOPS: Pic récent → retournement baissier / toujours élevé',
  'news.geo':'🌍 Géopolitique: risque Moyen-Orient non pleinement résolu (Hormuz·tensions régionales persistantes)',
  'news.marketSummary':'→ Pic de mai intégré ; juin pourrait voir une légère pression baissière, limitée par le change et la géopolitique',
  'news.decisionTitle':'📌 Guide de décision actuel',
  'news.decisionLine1':'→ Mai : pic de prix déjà intégré',
  'news.decisionLine2':'→ Juin : la baisse du pétrole peut réduire la surcharge',
  'news.decisionShort':'👉 Voyage court terme (1–2 mois) : réservez maintenant',
  'news.decisionLong':'👉 Planning flexible : attendez la tendance de juin',
  ...
  'news.predict.mopsValue':'Moyenne récente en baisse',
  'news.predict.fxLabel':'Taux USD/KRW',
  'news.predict.fxUnit':'',
  'news.predict.fxArrow':'→',
  'news.predict.brentUnit':'/ baril',
  'news.predict.geoLabel':'Risque géopolitique',
  'news.predict.geoValue':'Modéré (signes de détente)',
  'news.predict.outlookLabel':'prévision surcharge',
  'news.predict.outlook.flat':'Maintien ~ légère baisse possible',
...
de:{
  ...
  'news.brent':'⛽ Brent-Rohöl: $105–106 / Barrel',
  'news.fx':'💱 USD/KRW: KRW 1.470er Bereich (oberes Ende)',
  'news.mops':'✈️ Kerosin/MOPS: Jüngster Höchststand → Rückgang / weiterhin hoch',
  'news.geo':'🌍 Geopolitik: Nahost-Risiko nicht vollständig gelöst (Hormuz·regionale Spannungen anhalten)',
  'news.marketSummary':'→ Mai-Zuschlag hat Hochpunkt vollständig eingepreist; Juni könnte begrenzten Abwärtsdruck sehen, durch Wechselkurs und Geopolitik gedämpft',
  'news.decisionTitle':'📌 Aktuelle Entscheidungshilfe',
  'news.decisionLine1':'→ Mai: Hochpreisphase bereits abgeschlossen',
  'news.decisionLine2':'→ Juni: Ölpreisrückgang könnte Senkung auslösen',
  'news.decisionShort':'👉 Kurzreise (1–2 Monate): Jetzt buchen ist vorteilhaft',
  'news.decisionLong':'👉 Flexibler Zeitplan: Entwicklung im Juni abwarten',
  ...
  'news.predict.mopsValue':'Jüngster Durchschnitt dreht nach unten',
  'news.predict.fxLabel':'USD/KRW-Kurs',
  'news.predict.fxUnit':'',
  'news.predict.fxArrow':'→',
  'news.predict.brentUnit':'/ Barrel',
  'news.predict.geoLabel':'Geopolitisches Risiko',
  'news.predict.geoValue':'Mittel (Entspannungszeichen)',
  'news.predict.outlookLabel':'Zuschlag-Ausblick',
  'news.predict.outlook.flat':'Halten ~ leichte Senkung möglich',
